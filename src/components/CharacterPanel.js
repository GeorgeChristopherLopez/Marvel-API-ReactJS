        ...
        return (
            <section style={showcaseSectionStyle} className="showcase">
                ...
                <div className="hero-card">
                    <img style={imageStyle} src="http://i.annihil.us/u/prod/marvel/i/mg/6/a0/55b6a25e654e6/standard_xlarge.jpg" />
                    <div>   <p style={captionStyle}>Iron Man</p></div>
                </div>
                <div className="hero-card">
                            <img style={imageStyle} src="http://i.annihil.us/u/prod/marvel/i/mg/3/50/537ba56d31087/standard_xlarge.jpg" />
                    <div>   <p style={captionStyle}>Captain America</p></div>
                </div>
                <div className="hero-card">
                            <img style={imageStyle} src="http://i.annihil.us/u/prod/marvel/i/mg/d/d0/5269657a74350/standard_xlarge.jpg" />
                    <div>   <p style={captionStyle}>Thor</p></div>
                </div>
                <div className="hero-card">
                            <img style={imageStyle} src="http://i.annihil.us/u/prod/marvel/i/mg/5/a0/538615ca33ab0/standard_xlarge.jpg" />
